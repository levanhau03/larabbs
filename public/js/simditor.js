...
Simditor.i18n = {
  'zh-CN': {
   ...
   'vi': {
    ...
    'code': 'Mã',
    'color': 'Màu',
    'coloredText': 'Màu văn bản',
    'hr': 'Dấu phân cách',
    'image': 'Chèn hình',
    'externalImage': 'Hình bên ngoài',
    'uploadImage': 'Tải lên hình',
    'uploadFailed': 'Tải lên thất bại',
    'uploadError': 'Xảy ra lỗi khi tải lên',
    'imageUrl': 'Địa chỉ hình ảnh',
    'imageSize': 'Kích thước',
    'imageAlt': 'Mô tả hình ảnh',
    'restoreImageSize': 'Khôi phục kích thước gốc',
    ...
    'linkTarget': 'Phương thức mở',
    'openLinkInCurrentWindow': 'Mở liên kết trong cửa sổ hiện tại',
    'openLinkInNewWindow': 'Mở liên kết trong cửa sổ mới',
